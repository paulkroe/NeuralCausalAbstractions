...
class CustomNN(nn.Module):
    def __init__(self, pa_size, u_size, o_size, pa_type, o_type, img_size=32,
        ...
        print(f"CustomNN: {self.pa} -> {self.o_type} ({self.mode})")
        print(f"CustomNN: {self.u} -> {self.o_type} ({self.mode})")
        print(f"CustomNN: {self.pa_size} -> {self.o_type} ({self.mode})")
        print(f"CustomNN: {self.u_size} -> {self.o_type} ({self.mode})")
        print("=======")
